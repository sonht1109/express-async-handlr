...
describe('express-async-interceptor', () => {
  it('should propagates routes errors to error handler', () => {
    const app = express();
    ...
    return supertest(app).get('/test').expect(495);
  });

  it('should propagates regular middleware errors', () => {
    const app = express();
  ...
  it('should propagates error middleware errors', () => {
    const app = express();
  ...
  it('and propagates param middleware errors too', () => {
    ...
    return supertest(app).get('/test/12').expect(495);
  });
  ...
  it('should preserve the router stack for external routes', () => {
    ...
    ok(routeData);
    equal(routeData.verb, 'get');
    equal(routeData.hasDescription, true);
  });
});
